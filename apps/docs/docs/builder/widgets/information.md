...
<div class="step">
  ...
  <div class="content">Click on the <code>Layer</code> widget, and then the Layer settings on the right will appear. Here you can add a <code>title</code> and a <code>description</code>.</div>
</div>
