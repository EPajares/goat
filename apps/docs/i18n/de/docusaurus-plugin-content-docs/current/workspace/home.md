...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
  <img src={require('/img/workspace/home/home.png').default} alt="Startseite Oberfläche Übersicht in GOAT" style={{ maxHeight: "auto", maxWidth: "auto", objectFit: "cover"}}/>
</div>
...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
  <img src={require('/img/workspace/home/recent_projects.png').default} alt="Neueste Projekte" style={{ maxHeight: "auto", maxWidth: "auto", objectFit: "cover"}}/>
</div>
...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
  <img src={require('/img/workspace/home/recent_datasets.png').default} alt="Neueste Datensätze" style={{ maxHeight: "auto", maxWidth: "auto", objectFit: "cover"}}/>
</div>
...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
  <img src={require('/img/workspace/home/explore.png').default} alt="Entdecken" style={{ maxHeight: "auto", maxWidth: "auto", objectFit: "cover"}}/>
</div>