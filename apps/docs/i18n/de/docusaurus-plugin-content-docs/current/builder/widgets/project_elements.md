...
Dieser Abschnitt bietet zusätzliche Widgets, **um Ihr Dashboard abzurunden**: **Text**, **Trennelement** und **Bild**. Ziehen Sie das Widget per Drag & Drop auf ein Panel.
...
**Laden Sie ein Bild** von Ihrem Computer in Ihr Dashboard hoch. Wenn **Abstand** aktiviert ist, wird ein *dickerer Rahmen um das Bild* hinzugefügt.
