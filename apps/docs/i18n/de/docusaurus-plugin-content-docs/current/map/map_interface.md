...
- <img src={require('/img/icons/sliders.png').default} alt="Eigenschaften" style={{ maxHeight: "20px", maxWidth: "20px", objectFit: "cover"}}/> <code>Eigenschaften</code>: <strong>Layer-Informationen anzeigen</strong>, Symbolik und Sichtbarkeitseinstellungen für den ausgewählten Layer.
...
- <img src={require('/img/icons/palette.png').default} alt="Layer-Design" style={{ maxHeight: "20px", maxWidth: "20px", objectFit: "cover"}}/> <code>Layer-Design</code>: <strong>Den Stil gestalten</strong> Ihrer Layer. Lesen Sie mehr in [Layer-Styling](../category/layer-styling).
