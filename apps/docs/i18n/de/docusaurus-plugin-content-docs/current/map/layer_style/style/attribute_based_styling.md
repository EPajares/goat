...
Sie können Ihre Palette anpassen, indem Sie den <code>Typ</code> auswählen, <code>Schritte</code> anpassen, Farben <code>Umkehren</code> oder <code>Benutzerdefiniert</code> für Ihren eigenen Farbbereich aktivieren.
...
:::tip HINWEIS
Um Ihren **Datensatz** mit den Styling-Einstellungen in anderen **Projekten** zu verwenden, [speichern Sie Ihren Stil als Standard](../layer_style/styling#standard-einstellungen).
:::